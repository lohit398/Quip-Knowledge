...
function quiptext(text, placeholders) {
    ...
    const replaceAll = function (str, substr, replacement) {
        return str.replace(new RegExp(substr.replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1"), "g"), replacement);
    };
    ...
    if (placeholders) {
        ...
        for (const key in placeholders) {
            ...
            if (typeof val !== "string" && val && react_1.default.isValidElement(val)) {
...
//# sourceMappingURL=quiptext.js.map